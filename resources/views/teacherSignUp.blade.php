...
<head>
    ...
    <link href="<?php echo url('/'); ?>/vendor/datepicker/daterangepicker.css" rel="stylesheet" media="all">

    <!-- Main CSS-->
    <link href="../FrontEnd/css/mainTeacher.css" rel="stylesheet" media="all">
</head>
...
<header class="top-header">
        <nav class="navbar header-nav navbar-expand-lg">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.html"><img src="images/quizzards.png" alt="image"></a>
    ...
    <div class="page-wrapper bg-gra-03 p-t-45 p-b-50">
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST" action="teachercore.php">
    ...
    <script src="<?php echo url('/'); ?>/vendor/datepicker/moment.min.js"></script>
    <script src="<?php echo url('/'); ?>/vendor/datepicker/daterangepicker.js"></script>
